...
SHOP_NAME = "FakeShop3"
SHOP_URL = os.getenv("FAKE_MAGAZ_URL", "http://localhost:10001")  # Уникальный URL для магазина 3
...
if __name__ == '__main__':
    port = int(os.getenv("PORT", 10001))  # Уникальный порт для третьего магазина
